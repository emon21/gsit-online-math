                        ...
                        <div class="container-fluid">
                          <div class="row">
                            <div class="col-md-12 px-4 py-4">
                              <form action="{{ route('adviser.insert') }}" method="POST" enctype="multipart/form-data">
                                  @csrf
                                                  ...
                                                  <div class="mb-3">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 mb-3 mt-3">
                                                            ...
                                                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="desination_title" placeholder="Enter Desination Title..." name="desination_title" value="{{ old('desination_title') }}">
                                                          </div>
                                                          ...
                                                          {{-- <div class="form-group">
                                                            <label> Image </label>
                                                            <input type="file" name="img_upload" class="form-control @error('img_upload') is-invalid @enderror ">
                                                            @error('img_upload')
                                                    ...
                                                    <button type="submit" class="btn btn-primary mt-2">Add Adviser</button>
