<x-guest-layout>
    <x-navbar></x-navbar>
    <div class="min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
        <div class="bg-gray-100 w-4/6 text-gray-500 rounded-3xl shadow-xl overflow-hidden" >

    <div class="flex">
        <div class="w-2/5 bg-indigo-500 py-10 px-10">
            ...
            <div class="md:flex w-full">
                <div class="w-full  py-10 px-5 md:px-10">
                    <div class="text-start mb-5">
                        <h1 class="font-bold text-3xl text-gray-900">বঙ্গবন্ধু ট্যুরিজম অলিম্পিয়াড নিবন্ধন</h1>
                        <p class="py-2">Bangabandu Tourism Olympiad Registration</p>
                    </div>
                    ...
                    <div>
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input  name="first_name" type="text" class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                </div>
                            </div>
                            {{-- <div>
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="email" class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                                </div>
                            </div>
                            ...
                            <div class="w-full px-3">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="password" class="w-full -ml-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <select class="bg-gray-50 mt-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500
                                     focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600
                                      dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
                                       dark:focus:border-blue-500" name="gender" id="gender" required>
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Educational Institute Name *</label>
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="email" class="w-full -ml-10  pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                                </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-12">
                                <label for="" class="text-xs font-semibold px-1">Institute Full Address * :</label>
                                <div class="flex">
                                    ...
                                    <textarea name="" id="" cols="30" rows="10" class="w-full -ml-10 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Division Name :</label>
                                <div>
                                    <i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <select id="countries" class="bg-gray-50 mt-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected>Choose a country</option>
                            ...
                            <div class="w-1/2 px-3 mb-5">
                                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upazila Name :</label>
                                <div>
                                    <i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <select id="countries" class="bg-gray-50 mt-2 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                        <option selected>Choose a country</option>
                        ...
                        {{-- <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button class="w-full mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER NOW</button>
                            </div>
                        </div> --}}

                        <div class="flex justify-between text-black text-lg">
