  ...
  <section class="">
    <div class="container px-5 py-24 mx-auto">
      ...
      <div class="p-4 w-3/4   text-white mx-auto flex justify-between gap-4">
        ...
        <div class="w-1/2  px-2 py-2 rounded border border-spacing-1 text-center hover:shadow transition-all duration-300 ease-in-out hover:scale-105 hover:bg-[#00aeef] cursor-pointer hover:text-white text-black">
